...
enum OnboardingSlidesLocalization {
    static let titleSlide1 = "Incredible emotions"
    static let descriptionSlide1 = "An exciting storyline will take you into a fantasy world or help you experience all the variety of real storylines"
    static let titleSlide2 = "Unique experiences"
    static let descriptionSlide2 = "The combination of colorful images and high-quality sound will give you a unique experience"
    static let titleSlide3 = "Amazing graphics"
...
enum DetailMoviesLocalization {
    ...
    static let alertTitleDetailVC = "Added"
    static let alertMessageDetailVC = "Let's Watch Later"
